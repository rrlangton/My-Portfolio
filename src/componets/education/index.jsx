function Education () {
    ...
    <section id="testimonial">
        <div class="container">
            <h6 class="section-subtitle text-center">My background</h6>
            <h6 class="section-title text-center mb-6">Education</h6>
            <div class="row">
                <div class="col-md-6">
                    <div class="testimonial-wrapper">
                        ...
                        <div class="body">
                            <p class="subtitle">University of Missouri</p>
                            <h6 class="title">Bachelor of Arts in Psychology, Multi-Cultural Studies</h6>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="testimonial-wrapper">
                        ...
                        <div class="body">
                            <p class="subtitle">Northwestern Coding Bootcamp</p>
                            <h6 class="title">Full Stack Web Development</h6>
                        </div>
                    </div>
                </div>
            </div>
